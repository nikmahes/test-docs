...
[![Build Status](https://travis-ci.org/nikmahes/test-docs.svg?branch=master)](https://travis-ci.org/nikmahes/test-docs)
...
6. If you did everything correct, https://nikmahes.github.io/test-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://nikmahes.github.io/test-docs/
- SwaggerUI: https://nikmahes.github.io/test-docs/swagger-ui/
- Look full spec:
    + JSON https://nikmahes.github.io/test-docs/swagger.json
    + YAML https://nikmahes.github.io/test-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://nikmahes.github.io/test-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://nikmahes.github.io/test-docs/ with url from the message: `Server started <url>`
